...
<div class="container">
    ...
    <p>Es un placer comunicarte que después de revisar cuidadosamente tu aplicación para el puesto de [Nombre del Puesto], nos complace informarte que has sido seleccionado/a para avanzar en nuestro proceso de selección y participar en una entrevista.</p>
    ...
    <p>Durante la entrevista, tendrás la oportunidad de discutir más a fondo tus habilidades, experiencia y expectativas con nuestro equipo de reclutamiento. También tendrás la oportunidad de aprender más sobre nuestra empresa y el rol específico para el cual estás siendo considerado/a.</p>
    <p>Para confirmar tu disponibilidad para la entrevista, por favor presiona en el botón de abajo</p>
    <p>{{$entrevista->detalles}}</p>
    <p>Estamos emocionados de conocerte y discutir cómo puedes contribuir al equipo en [Nombre de la Empresa]. ¡Esperamos con ansias nuestra reunión!</p>
