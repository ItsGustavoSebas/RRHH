...
<body>
    <div class="container">
        <h1 class="header">Tu Solicitud de Permiso Ha Sido Rechazada</h1>
        <p>Hola, {{ $notifiable->name }}:</p>
        <p>Lamentamos informarte que tu solicitud de permiso ha sido rechazada. A continuación, encontrarás los detalles de la solicitud:</p>
        <ul>
            <li>Fecha de inicio: {{ $permiso->fecha_inicio }}</li>
            <li>Fecha de finalización: {{ $permiso->fecha_fin }}</li>
            <li>Motivo: {{ $permiso->motivo }}</li>
            <li>Razón del rechazo: {{ $permiso->razon_rechazo }}</li>
        </ul>
