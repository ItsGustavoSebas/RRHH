<x-app-layout>
    ...
    <form action="{{ route('postulantes.actualizarGES', ['id' => auth()->id()]) }}" method="POST" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            ...
                            @error('ID_NivelIdioma')
                                <strong class = "text-red-500">Debes seleccionar un nivel del idioma</strong>
                            @enderror
                        </div>
                    </div>
                </div>
