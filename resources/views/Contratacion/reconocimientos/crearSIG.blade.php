<x-app-layout>
    ...
    <head>
        ...
        <style>
         ...
         <title>Añadir reconocimientos</title>
        </head>
        <form action="{{ route('reconocimientos.guardarSIG') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="bg-gradient-to-r from-indigo-700 to-indigo-950 p-8">
                ...
                <div class="bg-gray-100 p-4 overflow-hidden shadow-xl sm:rounded-lg m-5 ">
                    <div class= "text-center font-sans text-black font-bold text-3xl antialiased pb-10 mt-10">
                        REGISTRE SUS RECONOCIMIENTOS
                    </div>
                    <div>
                        <label class="font-bold text-lg" for="">Nombre del reconocimiento</label>
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                <div class="flex">
                                    ...
                                    <input id= "nombre" type="string" name="nombre"
                                        ...
                                        placeholder="Ingrese el nombre del reconocimiento" value="{{ old('nombre') }}">
                                    @error('nombre')
