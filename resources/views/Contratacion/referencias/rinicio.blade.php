                ...
                <table class="min-w-full border-collapse block md:table">
                    ...
                    @if (!is_null($referencias))
                        ...
                        <tr class="bg-white border border-grey-500 md:border-none block md:table-row">
                            ...
                            <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span
                                    class="inline-block w-1/3 md:hidden font-bold">Nombre de la persona</span>{{ $referencia->nombre }}</td>
                            <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span
                                    ...
                                    <div class="flex flex-wrap">
                                        <div>
                                            <form id="formEliminar_{{ $referencia->id }}"
                                                action="{{ route('referencias.eliminar', $referencia->id) }}" method="POST">
                                                @csrf
