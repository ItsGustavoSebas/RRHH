<x-app-layout>
    ...
    <form action="{{ route('horarios.guardar') }}" method="POST" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="w-full md:w-1/3 px-3 mb-5">
                        ...
                        <div class="flex">
                            ...
                            <input id="HoraInicio" type="time" name="HoraInicio"
                                ...
                                placeholder="Ejemplo 07:00" value="{{ old('HoraInicio') }}">
                        </div>
                        @error('HoraInicio')
                    ...
                    <div class="w-full md:w-1/3 px-3 mb-5">
                        ...
                        <div class="flex">
                            ...
                            <input id="HoraFin" type="time" name="HoraFin"
                                class="w-full -ml-10 pl-10 pr-3 py-2 rounded-2xl border-2 border-gray-200 outline-none focus:border-indigo-500"
                                placeholder="Ejemplo 13:00" value="{{ old('HoraFin') }}">
                        </div>
                        @error('HoraFin')
                    ...
                    <div class="w-full md:w-1/3 px-3 mb-5">
                        ...
                        <div class="flex">
                            ...
                            <input id="HoraLimite" type="time" name="HoraLimite"
                                class="w-full -ml-10 pl-10 pr-3 py-2 rounded-2xl border-2 border-gray-200 outline-none focus:border-indigo-500"
                                placeholder="Ejemplo 07:30" value="{{ old('HoraLimite') }}">
                        </div>
                    </div>
                </div>
                @can('Guardar Horarios')
